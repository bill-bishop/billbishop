...
export class GameModel {
    constructor() {
        ...
        this.objects = [
            new GameObject(203, 933, 9, 'Bio', 'dot', 0, new Interaction('navigate', { url: 'bio.html' })),
            new GameObject(509, 968, 9, 'GitHub', 'dot', 0, new Interaction('navigate', { url: 'https://github.com/bill-bishop' })),
